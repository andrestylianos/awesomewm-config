...
--for s = 1, screen.count() do
    ...
    --tags[s] = awful.tag({ "Video", "WWW", "Chat", "Code", "Music", "Files", "Torrent", 8, 9 }, s, layouts[1])
--end
 -- {{{ Tags
 tags = {
   names  = { "Video", "WWW", "Chat", "Code", "Music", "Files", "Torrent", 8, 9},
   layout = { layouts[9], layouts[2], layouts[9], layouts[3], layouts[9],
              layouts[8], layouts[3], layouts[5], layouts[6]
 }}
...
globalkeys = awful.util.table.join(
   ...
   -- awful.key({ modkey,   }, "KP_Enter", function () awful.util.spawn("sh /home/pantera/repos/shell-scripts/volup.sh") end),
